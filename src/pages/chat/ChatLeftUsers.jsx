  ...
  return (
    <div style={{ height: "calc(100% - 105px)" }}>
      <Stack id="chat__leftUserAllUsersDiv" direction="column" spacing={0.5}>
        <Stack className="chat__leftUser" direction="row" alignItems="center" spacing={1}>
          ...
          <Stack direction="column">
            ...
            >
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Fugit inventore, itaque modi tenetur illo aliquam quis obcaecati beatae eveniet dolorum.
            </Typography>
          </Stack>
        </Stack>
        <Stack className="chat__leftUser" direction="row" alignItems="center" spacing={1}>
